...
import {checkAccess} from "../middlewares/check-refresh-id-tokena";
...
securityRoute.delete('/devices/:id', validDeviceId, checkRefreshTokena, checkAccess, async (req: Request, res: Response<boolean>) => {
