...
blogsRoute.get('/:blogId/posts', checkBlogIdValidForMongodb, pageValidations, async (req: RequestWithParamsAndQeury<URIParams_BlogModel,QeuryParams_GetPostsModel>,
